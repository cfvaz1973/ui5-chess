		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Chess",
									"targetURL": "#ui5futureviewui5chess-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5futureviewui5chess-display": {
								"semanticObject": "ui5futureviewui5chess",
								"action": "display",
								"description": "UI5 Chess",
								"title": "UI5 Chess",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.futureview.ui5chess",
									"url": sap.ui.require.toUrl("ui5/futureview/ui5chess")
								}
							}
						}
					}
